...
function readURL(input) {
    ...
    var x = new FileReader("http://localhost:59545/content/documents/843410.pdf");
    var files = x.files;
...
function loadOCR(uri) {
    ...
    img.onload = function () {
        ...
        $.ajax({
            url: "http://rpandey-w1.corp.firstam.com/api/SmartTextExtractor",
            type: 'POST',
            ...
            success: function (data) {
                if (!nicEditors.findEditor('ResponseCmpr2')) {
                    new nicEditor({ fontFormat: "Pre", fullPanel: true, iconsPath: 'http://rpandey-w1.corp.firstam.com/SmartTextClient/nicEditorIcons.gif' }).panelInstance('ResponseCmpr2');
                }
                ...
                wordSpans.each(function (a, b) {
                    ...
                    .contextMenu('myMenu', {
                        onContextMenu: function (e) {
                            ...
                            var isTrue = false;
                            $.ajax({
                                url: "http://rpandey-w1.corp.firstam.com/SmartText/SpellCheck/CheckSpelling",
                                type: 'POST',
                                contentType: 'application/json; charset=utf-8',
                                dataType: 'json',
                                async: false,
                        ...
                        onShowMenu: function (e, menu) {
                            $("#suggestions li").click(function (menuItem) {
                                if (menuItem.target.getAttribute("id") == "addDic") {
                                    $.ajax({
                                        url: "http://rpandey-w1.corp.firstam.com/SmartText/SpellCheck/AddWord",
                                        type: 'POST',
                                        contentType: 'application/json; charset=utf-8',
                                        dataType: 'json',
                                        async: false,
...
function onCanvasClick(canvasElement) {
    ...
    $.ajax({
        url: "http://rpandey-w1.corp.firstam.com/SmartText/api/SmartTextExtractor",
        type: 'POST',
        contentType: 'application/json; charset=utf-8',
        dataType: 'json',
        data: JSON.stringify(dataUrl),
